public class Lab2 {
	...
	if (manGoingToStIves) {
	    ...
	    total = numWives+(numSacksPerWife*numWives)+(numCatsPerSack*numWives*numSacksPerWife)+ 
		(numCatsPerSack*numWives*numSacksPerWife*numKitsPerCat)+narrator + man;
	} else {
